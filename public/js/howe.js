...
var login = {
	...
	signup: function () {
		var signObj = $('.isignup');
		var usernameObj = $('#username_ezone'),
			username = usernameObj.val(),
			usernameOk = false,
			pwdObj = $('#password_ezone'),
			pwd = pwdObj.val(),
			pwdOk = false,
			confirmPwdObj = $('#repassword_ezone'),
			confirmPwd = confirmPwdObj.val(),
			confirmPwdOk = false,
			realnameObj = $('#realname_ezone'),
			realname = realnameObj.val(),
			realnameOk = false,
			identityObj = $('#id_no_ezone'),
			identity = identityObj.val(),
			identityOk = false,
			phoneObj = $('#phone_ezone'),
			phone = phoneObj.val(),
			phoneOk = false,
			readObj = $('#read'),
